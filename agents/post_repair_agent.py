        ...
        *,
        ...
        user = {
            ...
            "instructions": (
                ...
                "- If RULE_EMPTY_PICK_BODIES: for each empty pick body, write a short 2–4 sentence description inside that pick's body field.\n"
                "  Use only the product title + generic suitability language; do not add specific specs or claims.\n"
                "  Include exactly one sentence that starts with 'Skip it if' for each newly-filled pick body.\n"
                "- If RULE_SUSPECT_LAP_COMPARTMENT_TYPO: replace 'lap compartment' with 'laptop compartment' where it appears.\n"
